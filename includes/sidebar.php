    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="app-sidebar__heading">EXÁMENES DISPONIBLES</li>
                <li>
                <a href="#">
                ...
                <ul >
                    <?php 
                        ...
                        { ?>
                            <a href="#">
                                <i class="metismenu-icon"></i>No hay exámenes
                            </a>
                        <?php }
                     ?>
                 ...
                 <li class="app-sidebar__heading">EXÁMENES REALIZADOS</li>
                <li>
                  <?php 
                    ...
                    { ?>
                        <a href="#" class="pl-3">Aún no has hecho el examen</a>
                    <?php }
