      ...
      <div class="app-page-title">
        <div class="page-title-wrapper">
          <div class="page-title-heading">
            <div> GESTIÓN DE EXÁMENES
              <div class="page-title-subheading">
                Añada preguntas para  <?php echo $selExamRow['ex_title']; ?>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="refreshData">
          <div class="row">
            <div class="col-md-6">
              <div class="main-card mb-3 card">
                <div class="card-header">
                  <i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>Información sobre el examen
                </div>
                <div class="card-body">
            ...
            <div class="col-md-6">
              ...
              ?>
              <div class="main-card mb-3 card">
                <div class="card-header"><i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>Preguntas del examen
                ...
                <div class="card-body">
                  <div class="scroll-area-sm" style="min-height: 400px;">
                    <div class="scrollbar-container">
                                ...
                                while ($selQuestionRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                                  <tr>
                                    ...
                                    <td class="text-center">
                                      ...
                                      <button type="button" id="deleteQuestion" data-id='<?php echo $selQuestionRow['eqt_id']; ?>' class="btn btn-danger btn-sm">Borrar</button>
                                    </td>
                                  </tr>
                                <?php }
                              } else { ?>
                      ...
                      <?php } else { ?>
                        <h4 class="text-primary">No se ha encontrado ninguna pregunta...</h4>
                      <?php
                      }
                      ?>
                    </div>
