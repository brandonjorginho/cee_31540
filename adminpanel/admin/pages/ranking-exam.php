  ...
  <div class="app-main__inner">
        ...
        <div class="page-title-wrapper">
          <div class="page-title-heading">
            <div><b class="text-primary">RANKING</b><br>
              Resultados del examen de <?php echo $selEx['ex_title']; ?><br><br>
              <span class="border" style="padding:10px;color:black;background-color: yellow;">Satisfactorio</span>
              <span class="border" style="padding:10px;color:white;background-color: green;">Satisfactorio</span>
              <span class="border" style="padding:10px;color:white;background-color: blue;">En proceso</span>
              <span class="border" style="padding:10px;color:white;background-color: red;">En inicio</span>
              <span class="border" style="padding:10px;color:black;background-color: #E9ECEE;">No respondio</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <?php
      ...
      <div class="app-page-title">
        <div class="page-title-wrapper">
          <div class="page-title-heading">
            <div><b>CLASIFICACIÓN POR EXAMEN</b></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="main-card mb-3 card">
          <div class="card-header">Lista de exámenes
          </div>
          <div class="table-responsive">
            <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
              <thead>
                <tr>
                  <th class="text-left pl-4">Título del examen</th>
                  <th class="text-left ">Curso</th>
                  <th class="text-left ">Descripcion</th>
                  <th class="text-center" width="8%">Detalles</th>
                </tr>
              </thead>
              <tbody>
                <?php
                ...
                if ($selExam->rowCount() > 0) {
                  ...
                  <tr>
                    <td colspan="5">
                      <h3 class="p-3">No se ha encontrado ningún examen</h3>
                    </td>
                  </tr>
                <?php }
                ?>
